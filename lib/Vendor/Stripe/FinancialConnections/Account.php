 ...
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $account_holder The account holder that this account belongs to.
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $balance The most recent information about the account's balance.
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $balance_refresh The state of the most recent attempt to refresh the account balance.
 ...
 * @property null|string|\Dlparker1005\MozartTest\Vendor\Stripe\FinancialConnections\AccountOwnership $ownership The most recent information about the account's owners.
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $ownership_refresh The state of the most recent attempt to refresh the account owners.
 ...
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $transaction_refresh The state of the most recent attempt to refresh the account transactions.
 */
class Account extends \Dlparker1005\MozartTest\Vendor\Stripe\ApiResource
{
     ...
     *
     * @return \Dlparker1005\MozartTest\Vendor\Stripe\FinancialConnections\Account the disconnected account
     */
     ...
     * @throws \Dlparker1005\MozartTest\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Dlparker1005\MozartTest\Vendor\Stripe\Collection<\Dlparker1005\MozartTest\Vendor\Stripe\FinancialConnections\AccountOwner> list of account owners
     */
     ...
     * @throws \Dlparker1005\MozartTest\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Dlparker1005\MozartTest\Vendor\Stripe\FinancialConnections\Account the refreshed account
     */
     ...
     * @throws \Dlparker1005\MozartTest\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Dlparker1005\MozartTest\Vendor\Stripe\FinancialConnections\Account the subscribed account
     */
     ...
     * @throws \Dlparker1005\MozartTest\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Dlparker1005\MozartTest\Vendor\Stripe\FinancialConnections\Account the unsubscribed account
     */
