...
/**
 * A <code>Transfer</code> object is created when you move funds between Dlparker1005\MozartTest\Vendor\Stripe accounts as
 * part of Connect.
 *
 * Before April 6, 2017, transfers also represented movement of funds from a
 * Dlparker1005\MozartTest\Vendor\Stripe account to a card or bank account. This behavior has since been split
 ...
 * @property null|string|\Dlparker1005\MozartTest\Vendor\Stripe\BalanceTransaction $balance_transaction Balance transaction that describes the impact of this transfer on your account balance.
 ...
 * @property null|string|\Dlparker1005\MozartTest\Vendor\Stripe\Account $destination ID of the Dlparker1005\MozartTest\Vendor\Stripe account the transfer was sent to.
 * @property null|string|\Dlparker1005\MozartTest\Vendor\Stripe\Charge $destination_payment If the destination is a Dlparker1005\MozartTest\Vendor\Stripe account, this will be the ID of the payment that the destination account received for the transfer.
 ...
 * @property \Dlparker1005\MozartTest\Vendor\Stripe\Collection<\Dlparker1005\MozartTest\Vendor\Stripe\TransferReversal> $reversals A list of reversals that have been applied to the transfer.
 ...
 * @property null|string|\Dlparker1005\MozartTest\Vendor\Stripe\Charge $source_transaction ID of the charge or payment that was used to fund the transfer. If null, the transfer was funded from the available balance.
...
class Transfer extends ApiResource
{
     ...
     *
     * @return \Dlparker1005\MozartTest\Vendor\Stripe\Collection<\Dlparker1005\MozartTest\Vendor\Stripe\TransferReversal> the list of transfer reversals
     */
     ...
     * @throws \Dlparker1005\MozartTest\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Dlparker1005\MozartTest\Vendor\Stripe\TransferReversal
     */
