 ...
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $address The customer's address.
 * @property null|int $balance The current balance, if any, that's stored on the customer. If negative, the customer has credit to apply to their next invoice. If positive, the customer has an amount owed that's added to their next invoice. The balance only considers amounts that Dlparker1005\MozartTest\Vendor\Stripe hasn't successfully applied to any invoice. It doesn't reflect unpaid invoices. This balance is only taken into account after invoices finalize.
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\CashBalance $cash_balance The current funds being held by Dlparker1005\MozartTest\Vendor\Stripe on behalf of the customer. You can apply these funds towards payment intents when the source is &quot;cash_balance&quot;. The <code>settings[reconciliation_mode]</code> field describes if these funds apply to these payment intents manually or automatically.
 ...
 * @property null|string|\Dlparker1005\MozartTest\Vendor\Stripe\Account|\Dlparker1005\MozartTest\Vendor\Stripe\BankAccount|\Dlparker1005\MozartTest\Vendor\Stripe\Card|\Dlparker1005\MozartTest\Vendor\Stripe\Source $default_source <p>ID of the default payment source for the customer.</p><p>If you use payment methods created through the PaymentMethods API, see the <a href="https://stripe.com/docs/api/customers/object#customer_object-invoice_settings-default_payment_method">invoice_settings.default_payment_method</a> field instead.</p>
 ...
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\Discount $discount Describes the current discount active on the customer, if there is one.
 * @property null|string $email The customer's email address.
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $invoice_credit_balance The current multi-currency balances, if any, that's stored on the customer. If positive in a currency, the customer has a credit to apply to their next invoice denominated in that currency. If negative, the customer has an amount owed that's added to their next invoice denominated in that currency. These balances don't apply to unpaid invoices. They solely track amounts that Dlparker1005\MozartTest\Vendor\Stripe hasn't successfully applied to any invoice. Dlparker1005\MozartTest\Vendor\Stripe only applies a balance in a specific currency to an invoice after that invoice (which is in the same currency) finalizes.
 * @property null|string $invoice_prefix The prefix for the customer used to generate unique invoice numbers.
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $invoice_settings
 ...
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $shipping Mailing and shipping address for the customer. Appears on invoices emailed to this customer.
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\Collection<\Dlparker1005\MozartTest\Vendor\Stripe\Account|\Dlparker1005\MozartTest\Vendor\Stripe\BankAccount|\Dlparker1005\MozartTest\Vendor\Stripe\Card|\Dlparker1005\MozartTest\Vendor\Stripe\Source> $sources The customer's payment sources, if any.
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\Collection<\Dlparker1005\MozartTest\Vendor\Stripe\Subscription> $subscriptions The customer's current subscriptions, if any.
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $tax
 ...
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\Collection<\Dlparker1005\MozartTest\Vendor\Stripe\TaxId> $tax_ids The customer's tax IDs.
 * @property null|string|\Dlparker1005\MozartTest\Vendor\Stripe\TestHelpers\TestClock $test_clock ID of the test clock that this customer belongs to.
 */
class Customer extends ApiResource
{
     ...
     *
     * @return \Dlparker1005\MozartTest\Vendor\Stripe\Customer the updated customer
     */
     ...
     *
     * @return \Dlparker1005\MozartTest\Vendor\Stripe\Collection<\Dlparker1005\MozartTest\Vendor\Stripe\PaymentMethod> list of payment methods
     */
     ...
     * @throws \Dlparker1005\MozartTest\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Dlparker1005\MozartTest\Vendor\Stripe\PaymentMethod the retrieved payment method
     */
    public function retrievePaymentMethod($payment_method, $params = null, $opts = null)
    {
        ...
        $obj = \Dlparker1005\MozartTest\Vendor\Stripe\Util\Util::convertToStripeObject($response, $opts);
        $obj->setLastResponse($response);
     ...
     * @throws \Dlparker1005\MozartTest\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Dlparker1005\MozartTest\Vendor\Stripe\SearchResult<\Dlparker1005\MozartTest\Vendor\Stripe\Customer> the customer search results
     */
     ...
     * @throws \Dlparker1005\MozartTest\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Dlparker1005\MozartTest\Vendor\Stripe\CashBalance
     */
     ...
     * @throws \Dlparker1005\MozartTest\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Dlparker1005\MozartTest\Vendor\Stripe\Collection<\Dlparker1005\MozartTest\Vendor\Stripe\CustomerBalanceTransaction> the list of customer balance transactions
     */
     ...
     * @throws \Dlparker1005\MozartTest\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Dlparker1005\MozartTest\Vendor\Stripe\CustomerBalanceTransaction
     */
     ...
     * @throws \Dlparker1005\MozartTest\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Dlparker1005\MozartTest\Vendor\Stripe\Collection<\Dlparker1005\MozartTest\Vendor\Stripe\CustomerCashBalanceTransaction> the list of customer cash balance transactions
     */
     ...
     * @throws \Dlparker1005\MozartTest\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Dlparker1005\MozartTest\Vendor\Stripe\CustomerCashBalanceTransaction
     */
     ...
     * @throws \Dlparker1005\MozartTest\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Dlparker1005\MozartTest\Vendor\Stripe\Collection<\Dlparker1005\MozartTest\Vendor\Stripe\BankAccount|\Dlparker1005\MozartTest\Vendor\Stripe\Card|\Dlparker1005\MozartTest\Vendor\Stripe\Source> the list of payment sources (BankAccount, Card or Source)
     */
     ...
     * @throws \Dlparker1005\MozartTest\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Dlparker1005\MozartTest\Vendor\Stripe\BankAccount|\Dlparker1005\MozartTest\Vendor\Stripe\Card|\Dlparker1005\MozartTest\Vendor\Stripe\Source
     */
     ...
     * @throws \Dlparker1005\MozartTest\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Dlparker1005\MozartTest\Vendor\Stripe\Collection<\Dlparker1005\MozartTest\Vendor\Stripe\TaxId> the list of tax ids
     */
     ...
     * @throws \Dlparker1005\MozartTest\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Dlparker1005\MozartTest\Vendor\Stripe\TaxId
     */
