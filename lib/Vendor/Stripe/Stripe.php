...
class Stripe
{
    /** @var string The Dlparker1005\MozartTest\Vendor\Stripe API key to be used for requests. */
    public static $apiKey;

    /** @var string The Dlparker1005\MozartTest\Vendor\Stripe client_id to be used for Connect requests. */
    public static $clientId;

    /** @var string The base URL for the Dlparker1005\MozartTest\Vendor\Stripe API. */
    public static $apiBase = 'https://api.stripe.com';

    /** @var string The base URL for the OAuth API. */
    public static $connectBase = 'https://connect.stripe.com';

    /** @var string The base URL for the Dlparker1005\MozartTest\Vendor\Stripe API uploads endpoint. */
    public static $apiUploadBase = 'https://files.stripe.com';

    /** @var string The version of the Dlparker1005\MozartTest\Vendor\Stripe API to use for requests. */
    public static $apiVersion = \Dlparker1005\MozartTest\Vendor\Stripe\Util\ApiVersion::CURRENT;
    ...
    /** @var float Maximum delay between retries, in seconds, that will be respected from the Dlparker1005\MozartTest\Vendor\Stripe API */
    ...
    /**
     * @return null|string The Dlparker1005\MozartTest\Vendor\Stripe account ID for connected account
     *   requests
     */
    ...
    /**
     * @param null|string $accountId the Dlparker1005\MozartTest\Vendor\Stripe account ID to set for connected
     *   account requests
     */
    ...
    /**
     * @return float Maximum delay between retries, in seconds, that will be respected from the Dlparker1005\MozartTest\Vendor\Stripe API
     */
     ...
     *
     * Client telemetry enables timing and request metrics to be sent back to Dlparker1005\MozartTest\Vendor\Stripe as an HTTP Header
     * with the current request. This enables Dlparker1005\MozartTest\Vendor\Stripe to do latency and metrics analysis without adding extra
