...
namespace Dlparker1005\MozartTest\Vendor\Stripe\HttpClient;

use Dlparker1005\MozartTest\Vendor\Stripe\Exception;
use Dlparker1005\MozartTest\Vendor\Stripe\Stripe;
use Dlparker1005\MozartTest\Vendor\Stripe\Util;
...
class CurlClient implements ClientInterface, StreamingClientInterface
{
    ...
    /** @var \Dlparker1005\MozartTest\Vendor\Stripe\Util\RandomGenerator */
     ...
     * @param null|\Dlparker1005\MozartTest\Vendor\Stripe\Util\RandomGenerator $randomGenerator
     */
     ...
     *   <li>\Dlparker1005\MozartTest\Vendor\Stripe\Util\CaseInsensitiveArray $rheaders The response headers</li>
    ...
    private function handleCurlError($url, $errno, $message, $numRetries)
    {
        switch ($errno) {
            ...
            case \CURLE_OPERATION_TIMEOUTED:
                $msg = "Could not connect to Dlparker1005\MozartTest\Vendor\Stripe ({$url}).  Please check your "
     ...
     * @param int $errno
     * @param int $rcode
     * @param array|\Dlparker1005\MozartTest\Vendor\Stripe\Util\CaseInsensitiveArray $rheaders
     * @param int $numRetries
     *
     * @return bool
     */
    ...
    private function canSafelyUseHttp2()
    {
        ...
        // (cf. https://github.com/curl/curl/issues/2416), which Dlparker1005\MozartTest\Vendor\Stripe use.
