 ...
 * @property null|string|\Dlparker1005\MozartTest\Vendor\Stripe\Issuing\Card $replaced_by The latest card that replaces this card, if any.
 * @property null|string|\Dlparker1005\MozartTest\Vendor\Stripe\Issuing\Card $replacement_for The card this card replaces, if any.
 * @property null|string $replacement_reason The reason why the previous card needed to be replaced.
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $shipping Where and how the card will be shipped.
 * @property \Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $spending_controls
 ...
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $wallets Information relating to digital wallets (like Apple Pay and Google Pay).
 */
class Card extends \Dlparker1005\MozartTest\Vendor\Stripe\ApiResource
{
