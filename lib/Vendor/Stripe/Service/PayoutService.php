...
class PayoutService extends \Dlparker1005\MozartTest\Vendor\Stripe\Service\AbstractService
{
    /**
     * Returns a list of existing payouts sent to third-party bank accounts or payouts
     * that Dlparker1005\MozartTest\Vendor\Stripe sent to you. The payouts return in sorted order, with the most
     ...
     *
     * @return \Dlparker1005\MozartTest\Vendor\Stripe\Collection<\Dlparker1005\MozartTest\Vendor\Stripe\Payout>
     */
     ...
     * Dlparker1005\MozartTest\Vendor\Stripe refunds the funds to your available balance. You can’t cancel automatic
     * Dlparker1005\MozartTest\Vendor\Stripe payouts.
     *
     * @param string $id
     * @param null|array $params
     * @param null|array|\Dlparker1005\MozartTest\Vendor\Stripe\Util\RequestOptions $opts
     ...
     * @throws \Dlparker1005\MozartTest\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Dlparker1005\MozartTest\Vendor\Stripe\Payout
     */
     ...
     * href="#balance">Dlparker1005\MozartTest\Vendor\Stripe balance</a> must cover the payout amount. If it doesn’t,
     ...
     *
     * If you create a manual payout on a Dlparker1005\MozartTest\Vendor\Stripe account that uses multiple payment
     ...
     * either a payout creation request or the payout list. Dlparker1005\MozartTest\Vendor\Stripe returns the
