...
class EphemeralKeyService extends \Dlparker1005\MozartTest\Vendor\Stripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \Dlparker1005\MozartTest\Vendor\Stripe\EphemeralKey
     */
    ...
    public function create($params = null, $opts = null)
    {
        if (!$opts || !isset($opts['stripe_version'])) {
            throw new \Dlparker1005\MozartTest\Vendor\Stripe\Exception\InvalidArgumentException('stripe_version must be specified to create an ephemeral key');
        }
