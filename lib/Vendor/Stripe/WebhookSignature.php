...
abstract class WebhookSignature
{
     ...
     * any reason.
     *
     * @param string $payload the payload sent by Dlparker1005\MozartTest\Vendor\Stripe
     * @param string $header the contents of the signature header sent by
     *  Dlparker1005\MozartTest\Vendor\Stripe
     ...
     *
     * The current scheme used by Dlparker1005\MozartTest\Vendor\Stripe ("v1") is HMAC/SHA-256.
     *
