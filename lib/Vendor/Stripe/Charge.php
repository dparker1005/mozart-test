...
/**
 * The <code>Charge</code> object represents a single attempt to move money into your Dlparker1005\MozartTest\Vendor\Stripe account.
 * PaymentIntent confirmation is the most common way to create Charges, but transferring
 * money to a different Dlparker1005\MozartTest\Vendor\Stripe account through Connect also creates Charges.
 ...
 * @property null|string|\Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $application ID of the Connect application that created the charge.
 * @property null|string|\Dlparker1005\MozartTest\Vendor\Stripe\ApplicationFee $application_fee The application fee (if any) for the charge. <a href="https://stripe.com/docs/connect/direct-charges#collecting-fees">See the Connect documentation</a> for details.
 ...
 * @property null|string|\Dlparker1005\MozartTest\Vendor\Stripe\BalanceTransaction $balance_transaction ID of the balance transaction that describes the impact of this charge on your account balance (not including refunds or disputes).
 * @property \Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $billing_details
 ...
 * @property null|string|\Dlparker1005\MozartTest\Vendor\Stripe\Customer $customer ID of the customer this charge is for if one exists.
 * @property null|string $description An arbitrary string attached to the object. Often useful for displaying to users.
 * @property bool $disputed Whether the charge has been disputed.
 * @property null|string|\Dlparker1005\MozartTest\Vendor\Stripe\BalanceTransaction $failure_balance_transaction ID of the balance transaction that describes the reversal of the balance on your account due to payment failure.
 ...
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $fraud_details Information on fraud assessments for the charge.
 * @property null|string|\Dlparker1005\MozartTest\Vendor\Stripe\Invoice $invoice ID of the invoice this charge is for if one exists.
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $level3
 ...
 * @property null|string|\Dlparker1005\MozartTest\Vendor\Stripe\Account $on_behalf_of The account (if any) the charge was made on behalf of without triggering an automatic transfer. See the <a href="https://stripe.com/docs/connect/separate-charges-and-transfers">Connect documentation</a> for details.
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $outcome Details about whether the payment was accepted, and why. See <a href="https://stripe.com/docs/declines">understanding declines</a> for details.
 * @property bool $paid <code>true</code> if the charge succeeded, or was successfully authorized for later capture.
 * @property null|string|\Dlparker1005\MozartTest\Vendor\Stripe\PaymentIntent $payment_intent ID of the PaymentIntent associated with this charge, if one exists.
 * @property null|string $payment_method ID of the payment method used in this charge.
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $payment_method_details Details about the payment method at the time of the transaction.
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $radar_options Options to configure Radar. See <a href="https://stripe.com/docs/radar/radar-session">Radar Session</a> for more information.
 ...
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\Collection<\Dlparker1005\MozartTest\Vendor\Stripe\Refund> $refunds A list of refunds that have been applied to the charge.
 * @property null|string|\Dlparker1005\MozartTest\Vendor\Stripe\Review $review ID of the review associated with this charge if one exists.
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $shipping Shipping information for the charge.
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\Account|\Dlparker1005\MozartTest\Vendor\Stripe\BankAccount|\Dlparker1005\MozartTest\Vendor\Stripe\Card|\Dlparker1005\MozartTest\Vendor\Stripe\Source $source This is a legacy field that will be removed in the future. It contains the Source, Card, or BankAccount object used for the charge. For details about the payment method used for this charge, refer to <code>payment_method</code> or <code>payment_method_details</code> instead.
 * @property null|string|\Dlparker1005\MozartTest\Vendor\Stripe\Transfer $source_transfer The transfer ID which created this charge. Only present if the charge came from another Dlparker1005\MozartTest\Vendor\Stripe account. <a href="https://stripe.com/docs/connect/destination-charges">See the Connect documentation</a> for details.
 ...
 * @property null|string|\Dlparker1005\MozartTest\Vendor\Stripe\Transfer $transfer ID of the transfer to the <code>destination</code> account (only applicable if the charge was created using the <code>destination</code> parameter).
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $transfer_data An optional dictionary including the account to automatically transfer to as part of a destination charge. <a href="https://stripe.com/docs/connect/destination-charges">See the Connect documentation</a> for details.
...
class Charge extends ApiResource
{
     ...
     * These strings are applicable to the decline_code property of the \Dlparker1005\MozartTest\Vendor\Stripe\Exception\CardException exception.
     *
     ...
     *
     * @return \Dlparker1005\MozartTest\Vendor\Stripe\Charge the captured charge
     */
     ...
     * @throws \Dlparker1005\MozartTest\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Dlparker1005\MozartTest\Vendor\Stripe\SearchResult<\Dlparker1005\MozartTest\Vendor\Stripe\Charge> the charge search results
     */
