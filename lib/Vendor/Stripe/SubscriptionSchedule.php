 ...
 * @property null|string|\Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $application ID of the Connect Application that created the schedule.
 ...
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $current_phase Object representing the start and end dates for the current phase of the subscription schedule, if it is <code>active</code>.
 * @property string|\Dlparker1005\MozartTest\Vendor\Stripe\Customer $customer ID of the customer who owns the subscription schedule.
 * @property \Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $default_settings
 ...
 * @property \Dlparker1005\MozartTest\Vendor\Stripe\StripeObject[] $phases Configuration for the subscription schedule's phases.
 ...
 * @property null|string|\Dlparker1005\MozartTest\Vendor\Stripe\Subscription $subscription ID of the subscription managed by the subscription schedule.
 * @property null|string|\Dlparker1005\MozartTest\Vendor\Stripe\TestHelpers\TestClock $test_clock ID of the test clock this subscription schedule belongs to.
 */
class SubscriptionSchedule extends ApiResource
{
     ...
     *
     * @return \Dlparker1005\MozartTest\Vendor\Stripe\SubscriptionSchedule the canceled subscription schedule
     */
     ...
     * @throws \Dlparker1005\MozartTest\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Dlparker1005\MozartTest\Vendor\Stripe\SubscriptionSchedule the released subscription schedule
     */
