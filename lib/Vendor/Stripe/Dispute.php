 ...
 * @property \Dlparker1005\MozartTest\Vendor\Stripe\BalanceTransaction[] $balance_transactions List of zero, one, or two balance transactions that show funds withdrawn and reinstated to your Dlparker1005\MozartTest\Vendor\Stripe account as a result of this dispute.
 * @property string|\Dlparker1005\MozartTest\Vendor\Stripe\Charge $charge ID of the charge that's disputed.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property string $currency Three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a>, in lowercase. Must be a <a href="https://stripe.com/docs/currencies">supported currency</a>.
 * @property \Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $evidence
 * @property \Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $evidence_details
 * @property bool $is_charge_refundable If true, it's still possible to refund the disputed payment. After the payment has been fully refunded, no further funds are withdrawn from your Dlparker1005\MozartTest\Vendor\Stripe account as a result of this dispute.
 ...
 * @property null|string|\Dlparker1005\MozartTest\Vendor\Stripe\PaymentIntent $payment_intent ID of the PaymentIntent that's disputed.
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $payment_method_details
...
class Dispute extends ApiResource
{
     ...
     *
     * @return \Dlparker1005\MozartTest\Vendor\Stripe\Dispute the closed dispute
     */
