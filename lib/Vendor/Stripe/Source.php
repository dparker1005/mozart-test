 ...
 * represent a customer's payment instrument, and can be used with the Dlparker1005\MozartTest\Vendor\Stripe API
 * just like a <code>Card</code> object: once chargeable, they can be charged, or can be
 * attached to customers.
 *
 * Dlparker1005\MozartTest\Vendor\Stripe doesn't recommend using the deprecated <a href="https://stripe.com/docs/api/sources">Sources API</a>.
 ...
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $ach_credit_transfer
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $ach_debit
 ...
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $card_present
 * @property string $client_secret The client secret of the source. Used for client-side retrieval using a publishable key.
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $code_verification
 ...
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $owner Information about the owner of the payment instrument that may be used or required by particular source types.
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $p24
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $receiver
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $redirect
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $sepa_credit_transfer
 ...
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $source_order
 ...
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $three_d_secure
 ...
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $wechat
 */
class Source extends ApiResource
{
     ...
     *
     * @throws \Dlparker1005\MozartTest\Vendor\Stripe\Exception\UnexpectedValueException if the source is not attached to a customer
     * @throws \Dlparker1005\MozartTest\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Dlparker1005\MozartTest\Vendor\Stripe\Source the detached source
     */
     ...
     * @throws \Dlparker1005\MozartTest\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Dlparker1005\MozartTest\Vendor\Stripe\Collection<\Dlparker1005\MozartTest\Vendor\Stripe\SourceTransaction> list of source transactions
     */
     ...
     * @throws \Dlparker1005\MozartTest\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Dlparker1005\MozartTest\Vendor\Stripe\Source the verified source
     */
