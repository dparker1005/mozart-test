...
namespace Dlparker1005\MozartTest\Vendor\Stripe\Identity;
 ...
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $last_error If present, this property tells you the last error encountered when processing the verification.
 * @property null|string|\Dlparker1005\MozartTest\Vendor\Stripe\Identity\VerificationReport $last_verification_report ID of the most recent VerificationReport. <a href="https://stripe.com/docs/identity/verification-sessions#results">Learn more about accessing detailed verification results.</a>
 ...
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $options A set of options for the session’s verification checks.
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $redaction Redaction status of this VerificationSession. If the VerificationSession is not redacted, this field will be null.
 ...
 * @property null|string $url The short-lived URL that you use to redirect a user to Dlparker1005\MozartTest\Vendor\Stripe to submit their identity information. This URL expires after 48 hours and can only be used once. Don’t store it, log it, send it in emails or expose it to anyone other than the user. Refer to our docs on <a href="https://stripe.com/docs/identity/verify-identity-documents?platform=web&amp;type=redirect">verifying identity documents</a> to learn how to redirect users to Stripe.
 * @property null|\Dlparker1005\MozartTest\Vendor\Stripe\StripeObject $verified_outputs The user’s verified data.
 */
class VerificationSession extends \Dlparker1005\MozartTest\Vendor\Stripe\ApiResource
{
     ...
     *
     * @return \Dlparker1005\MozartTest\Vendor\Stripe\Identity\VerificationSession the canceled verification session
     */
     ...
     * @throws \Dlparker1005\MozartTest\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Dlparker1005\MozartTest\Vendor\Stripe\Identity\VerificationSession the redacted verification session
     */
