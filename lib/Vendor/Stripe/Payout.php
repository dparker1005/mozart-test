 ...
 * Dlparker1005\MozartTest\Vendor\Stripe account</a>. You can retrieve individual payouts,
 ...
 * @property null|string|\Dlparker1005\MozartTest\Vendor\Stripe\BalanceTransaction $balance_transaction ID of the balance transaction that describes the impact of this payout on your account balance.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property string $currency Three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a>, in lowercase. Must be a <a href="https://stripe.com/docs/currencies">supported currency</a>.
 * @property null|string $description An arbitrary string attached to the object. Often useful for displaying to users.
 * @property null|string|\Dlparker1005\MozartTest\Vendor\Stripe\BankAccount|\Dlparker1005\MozartTest\Vendor\Stripe\Card $destination ID of the bank account or card the payout is sent to.
 * @property null|string|\Dlparker1005\MozartTest\Vendor\Stripe\BalanceTransaction $failure_balance_transaction If the payout fails or cancels, this is the ID of the balance transaction that reverses the initial balance transaction and returns the funds from the failed payout back in your balance.
 ...
 * @property null|string|\Dlparker1005\MozartTest\Vendor\Stripe\Payout $original_payout If the payout reverses another, this is the ID of the original payout.
 ...
 * @property null|string|\Dlparker1005\MozartTest\Vendor\Stripe\Payout $reversed_by If the payout reverses, this is the ID of the payout that reverses this payout.
...
class Payout extends ApiResource
{
     ...
     *
     * @return \Dlparker1005\MozartTest\Vendor\Stripe\Payout the canceled payout
     */
     ...
     * @throws \Dlparker1005\MozartTest\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Dlparker1005\MozartTest\Vendor\Stripe\Payout the reversed payout
     */
