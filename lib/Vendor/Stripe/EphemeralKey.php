 ...
 * @property null|string $secret The key's secret. You can use this value to make authorized requests to the Dlparker1005\MozartTest\Vendor\Stripe API.
 */
class EphemeralKey extends ApiResource
{
     ...
     *
     * @throws \Dlparker1005\MozartTest\Vendor\Stripe\Exception\InvalidArgumentException if stripe_version is missing
     * @throws \Dlparker1005\MozartTest\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Dlparker1005\MozartTest\Vendor\Stripe\EphemeralKey the created key
     */
