...
class StripeObject implements \ArrayAccess, \Countable, \JsonSerializable
{
    ...
    public function &__get($k)
    {
        ...
        if (!empty($this->_transientValues) && $this->_transientValues->includes($k)) {
            ...
            $message = "Dlparker1005\MozartTest\Vendor\Stripe Notice: Undefined property of {$class} instance: {$k}. "
        ...
        $class = static::class;
        Stripe::getLogger()->error("Dlparker1005\MozartTest\Vendor\Stripe Notice: Undefined property of {$class} instance: {$k}");
     ...
     * Dlparker1005\MozartTest\Vendor\Stripe object.
     *
    ...
    /**
     * Returns a pretty JSON representation of the Dlparker1005\MozartTest\Vendor\Stripe object.
     *
     * @return string the JSON representation of the Dlparker1005\MozartTest\Vendor\Stripe object
     */
    ...
    /**
     * @return null|ApiResponse The last response from the Dlparker1005\MozartTest\Vendor\Stripe API
     */
    ...
    /**
     * Sets the last response from the Dlparker1005\MozartTest\Vendor\Stripe API.
     *
